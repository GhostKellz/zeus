...
pub const DeviceDispatch = struct {
    ...
    pub fn load(device: types.VkDevice, proc: types.PFN_vkGetDeviceProcAddr) !DeviceDispatch {
        return DeviceDispatch{
            ...
            .create_swapchain = loadOptionalDeviceProc(?types.PFN_vkCreateSwapchainKHR, proc, device, "vkCreateSwapchainKHR"),
            .destroy_swapchain = loadOptionalDeviceProc(?types.PFN_vkDestroySwapchainKHR, proc, device, "vkDestroySwapchainKHR"),
            .get_swapchain_images = loadOptionalDeviceProc(?types.PFN_vkGetSwapchainImagesKHR, proc, device, "vkGetSwapchainImagesKHR"),
            .acquire_next_image = loadOptionalDeviceProc(?types.PFN_vkAcquireNextImageKHR, proc, device, "vkAcquireNextImageKHR"),
            .queue_present = loadOptionalDeviceProc(?types.PFN_vkQueuePresentKHR, proc, device, "vkQueuePresentKHR"),
